...
path_to_original_histograms = '../Histogram/'
output_filename = "../Histogram/bins250.pdf"
...
for label in labels:
    with np.load(path_to_original_histograms + 'hist_range_110-160_nbin-250_' + label + '.npz', 'rb') as data:
